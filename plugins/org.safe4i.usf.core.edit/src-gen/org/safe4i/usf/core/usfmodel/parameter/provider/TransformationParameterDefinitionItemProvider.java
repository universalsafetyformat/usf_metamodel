...
/**
 * This is the item provider adapter for a {@link org.safe4i.usf.core.usfmodel.parameter.TransformationParameterDefinition} object. <!-- begin-user-doc --> <!--
 * end-user-doc -->
 * 
 * @generated
 */
public class TransformationParameterDefinitionItemProvider extends NamedElementItemProvider {
	/**
	 * This constructs an instance from a factory and a notifier. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	public TransformationParameterDefinitionItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		final TransformationParameterDefinition element = (TransformationParameterDefinition) object;
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(TransformationParameterDefinition.class)) {
		case ParametersPackage.TRANSFORMATION_PARAMETER_DEFINITION__DOCUMENTATION:
		case ParametersPackage.TRANSFORMATION_PARAMETER_DEFINITION__UNIQUE_IDENTIFIER:
