...
import org.safe4i.usf.core.usfmodel.common.EnumerationLiteral;
import org.safe4i.usf.core.usfmodel.util.LabelProviderHelper;

/**
 * This is the item provider adapter for a {@link org.safe4i.usf.core.usfmodel.common.EnumerationLiteral} object. <!-- begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class EnumerationLiteralItemProvider extends ItemProviderAdapter
	...
	/**
	 * This adds a property descriptor for the Literal feature. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	protected void addLiteralPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_EnumerationLiteral_literal_feature"),
				getString("_UI_PropertyDescriptor_description", "_UI_EnumerationLiteral_literal_feature", "_UI_EnumerationLiteral_type"),
				CommonsPackage.Literals.ENUMERATION_LITERAL__LITERAL, true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addValuePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
				...
				CommonsPackage.Literals.ENUMERATION_LITERAL__VALUE, true, false, false, ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE, null, null));
	}

	/**
	 * This returns EnumerationLiteral.gif. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	@Override
	...
	public String getText(Object object) {
		String label = ((EnumerationLiteral) object).getLiteral();
		if (label == null || label.isEmpty()) {
			label = LabelProviderHelper.NO_NAME_LITERAL;
		}
		final EnumerationLiteral element = (EnumerationLiteral) object;
	...
	public void notifyChanged(Notification notification) {
		...
		case CommonsPackage.ENUMERATION_LITERAL__UNIQUE_IDENTIFIER:
		case CommonsPackage.ENUMERATION_LITERAL__LITERAL:
		case CommonsPackage.ENUMERATION_LITERAL__VALUE:
