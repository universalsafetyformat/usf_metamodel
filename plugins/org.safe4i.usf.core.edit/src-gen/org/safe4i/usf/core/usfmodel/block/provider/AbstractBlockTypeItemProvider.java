...
/**
 * This is the item provider adapter for a {@link org.safe4i.usf.core.usfmodel.block.AbstractBlockType} object. <!-- begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class AbstractBlockTypeItemProvider extends ItemProviderAdapter
	 ...
	 * @generated
	 */
	public AbstractBlockTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((AbstractBlockType) object).getName();
		if (label == null || label.isEmpty()) {
			label = LabelProviderHelper.NO_NAME_LITERAL;
		}
		final AbstractBlockType blockType = (AbstractBlockType) object;
		final String eClassName = LabelProviderHelper.INSTANCE.beautifyCamelCaseString(blockType.eClass().getName());
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(AbstractBlockType.class)) {
		case BlocksPackage.ABSTRACT_BLOCK_TYPE__NAME:
		case BlocksPackage.ABSTRACT_BLOCK_TYPE__UNIQUE_IDENTIFIER:
