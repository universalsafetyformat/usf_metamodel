...
/**
 * This is the item provider adapter for a {@link org.safe4i.usf.core.usfmodel.controlFlow.JoinNode} object. <!-- begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class JoinNodeItemProvider extends AbstractBlockTypeItemProvider {
	/**
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ControlFlowsPackage.Literals.JOIN_NODE__IN_CONTROL_FLOW_PORTS);
			childrenFeatures.add(ControlFlowsPackage.Literals.JOIN_NODE__OUT_CONTROL_FLOW_PORT);
		}
	...
	/**
	 * This returns JoinNode.gif. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	@Override
	...
	public void notifyChanged(Notification notification) {
		...
		case ControlFlowsPackage.JOIN_NODE__IN_CONTROL_FLOW_PORTS:
		case ControlFlowsPackage.JOIN_NODE__OUT_CONTROL_FLOW_PORT:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(
				createChildParameter(ControlFlowsPackage.Literals.JOIN_NODE__IN_CONTROL_FLOW_PORTS, ControlFlowsFactory.eINSTANCE.createControlFlowPort()));
		...
		newChildDescriptors.add(
				createChildParameter(ControlFlowsPackage.Literals.JOIN_NODE__OUT_CONTROL_FLOW_PORT, ControlFlowsFactory.eINSTANCE.createControlFlowPort()));
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		final boolean qualify = childFeature == ControlFlowsPackage.Literals.JOIN_NODE__IN_CONTROL_FLOW_PORTS
				|| childFeature == ControlFlowsPackage.Literals.JOIN_NODE__OUT_CONTROL_FLOW_PORT;
