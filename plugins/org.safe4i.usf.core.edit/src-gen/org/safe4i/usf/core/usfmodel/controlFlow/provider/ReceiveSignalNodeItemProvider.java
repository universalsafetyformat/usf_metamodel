...
/**
 * This is the item provider adapter for a {@link org.safe4i.usf.core.usfmodel.controlFlow.ReceiveSignalNode} object. <!-- begin-user-doc --> <!-- end-user-doc
 * -->
 * 
 * @generated
 */
public class ReceiveSignalNodeItemProvider extends SignalNodeItemProvider {
	/**
	 * This constructs an instance from a factory and a notifier. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	public ReceiveSignalNodeItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ControlFlowsPackage.Literals.RECEIVE_SIGNAL_NODE__OUT_CONTROL_FLOW_PORT);
		}
	...
	/**
	 * This returns ReceiveSignalNode.gif. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	@Override
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ReceiveSignalNode"));
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ReceiveSignalNode.class)) {
		case ControlFlowsPackage.RECEIVE_SIGNAL_NODE__OUT_CONTROL_FLOW_PORT:
