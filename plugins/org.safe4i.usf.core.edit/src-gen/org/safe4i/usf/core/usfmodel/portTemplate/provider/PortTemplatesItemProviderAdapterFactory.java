...
import org.safe4i.usf.core.usfmodel.portTemplate.PortTemplatesFactory;
import org.safe4i.usf.core.usfmodel.portTemplate.PortTemplatesPackage;
import org.safe4i.usf.core.usfmodel.portTemplate.util.PortTemplatesAdapterFactory;
 ...
 * @generated
 */
public class PortTemplatesItemProviderAdapterFactory extends PortTemplatesAdapterFactory
	 ...
	 * @generated
	 */
	public PortTemplatesItemProviderAdapterFactory() {
	...
	/**
	 * This keeps track of the one adapter used for all {@link org.safe4i.usf.core.usfmodel.portTemplate.TemplateType} instances. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @generated
	 */
	...
	/**
	 * This creates an adapter for a {@link org.safe4i.usf.core.usfmodel.portTemplate.TemplateType}. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	@Override
	...
	/**
	 * This keeps track of the one adapter used for all {@link org.safe4i.usf.core.usfmodel.portTemplate.TemplateAssignment} instances. <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	protected TemplateAssignmentItemProvider templateAssignmentItemProvider;

	/**
	 * This creates an adapter for a {@link org.safe4i.usf.core.usfmodel.portTemplate.TemplateAssignment}. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	@Override
	public Adapter createTemplateAssignmentAdapter() {
		if (templateAssignmentItemProvider == null) {
			templateAssignmentItemProvider = new TemplateAssignmentItemProvider(this);
		}

		return templateAssignmentItemProvider;
	}
	...
	public void dispose() {
		if (templateTypeItemProvider != null) {
			templateTypeItemProvider.dispose();
		}
		if (templateAssignmentItemProvider != null) {
			templateAssignmentItemProvider.dispose();
		}
	}
	...
	public static class CommonsChildCreationExtender implements IChildCreationExtender {
		...
		protected static class CreationSwitch extends CommonsSwitch<Object> {
			...
			public Object caseModel(Model object) {
				newChildDescriptors.add(createChildParameter(CommonsPackage.Literals.MODEL__CONTENT, PortTemplatesFactory.eINSTANCE.createTemplateType()));

				newChildDescriptors
						.add(createChildParameter(CommonsPackage.Literals.MODEL__CONTENT, PortTemplatesFactory.eINSTANCE.createTemplateAssignment()));
