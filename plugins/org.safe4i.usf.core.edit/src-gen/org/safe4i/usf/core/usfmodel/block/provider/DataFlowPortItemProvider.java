...
/**
 * This is the item provider adapter for a {@link org.safe4i.usf.core.usfmodel.block.DataFlowPort} object. <!-- begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class DataFlowPortItemProvider extends PortItemProvider {
	/**
	 * This constructs an instance from a factory and a notifier. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	public DataFlowPortItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_DataFlowPort_type_feature"),
				getString("_UI_PropertyDescriptor_description", "_UI_DataFlowPort_type_feature", "_UI_DataFlowPort_type"),
				BlocksPackage.Literals.DATA_FLOW_PORT__TYPE, true, false, true, null, null, null));
	}

	/**
	 * This returns DataFlowPort.gif. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	@Override
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/DataFlowPort"));
	}
