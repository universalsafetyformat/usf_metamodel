...
/**
 * This is the item provider adapter for a {@link org.safe4i.usf.core.usfmodel.block.UseRelationship} object. <!-- begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class UseRelationshipItemProvider extends BlockRelationshipItemProvider {
	/**
	 * This constructs an instance from a factory and a notifier. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	public UseRelationshipItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addUsesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_UseRelationship_uses_feature"),
				getString("_UI_PropertyDescriptor_description", "_UI_UseRelationship_uses_feature", "_UI_UseRelationship_type"),
				BlocksPackage.Literals.USE_RELATIONSHIP__USES, true, false, true, null, null, null));
	}

	/**
	 * This returns UseRelationship.gif. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated NOT
	 */
	@Override
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/UseRelationship"));
	}
