...
/**
 * This is the item provider adapter for a {@link org.safe4i.usf.core.usfmodel.parameter.PrimitiveParameterValue} object. <!-- begin-user-doc --> <!--
 * end-user-doc -->
 * 
 * @generated
 */
public class PrimitiveParameterValueItemProvider extends ItemProviderAdapter
	 ...
	 * @generated
	 */
	public PrimitiveParameterValueItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addParameterPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_PrimitiveParameterValue_parameter_feature"),
				getString("_UI_PropertyDescriptor_description", "_UI_PrimitiveParameterValue_parameter_feature", "_UI_PrimitiveParameterValue_type"),
				ParametersPackage.Literals.PRIMITIVE_PARAMETER_VALUE__PARAMETER, true, false, true, null, null, null));
	}
	...
	protected void addValuePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_PrimitiveParameterValue_value_feature"),
				getString("_UI_PropertyDescriptor_description", "_UI_PrimitiveParameterValue_value_feature", "_UI_PrimitiveParameterValue_type"),
				ParametersPackage.Literals.PRIMITIVE_PARAMETER_VALUE__VALUE, true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}

	/**
	 * This returns PrimitiveParameterValue.gif. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	@Override
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/PrimitiveParameterValue"));
	}
	...
	public String getText(Object object) {
		if (object instanceof EObject) {
			final String eClassName = LabelProviderHelper.INSTANCE.beautifyCamelCaseString(((EObject) object).eClass().getName());

			if (object instanceof PrimitiveParameterValue) {
				final PrimitiveParameterValue element = (PrimitiveParameterValue) object;
				return "[" + eClassName + "] " + element.getValue() != null ? element.getValue() : "No Value";
			} else {
				return "[" + eClassName + "]";
			}
		} else {
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(PrimitiveParameterValue.class)) {
		case ParametersPackage.PRIMITIVE_PARAMETER_VALUE__UNIQUE_IDENTIFIER:
		case ParametersPackage.PRIMITIVE_PARAMETER_VALUE__VALUE:
