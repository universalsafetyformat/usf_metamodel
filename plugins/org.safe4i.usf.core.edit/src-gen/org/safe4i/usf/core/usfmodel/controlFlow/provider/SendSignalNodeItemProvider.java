...
/**
 * This is the item provider adapter for a {@link org.safe4i.usf.core.usfmodel.controlFlow.SendSignalNode} object. <!-- begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class SendSignalNodeItemProvider extends SignalNodeItemProvider {
	/**
	 * This constructs an instance from a factory and a notifier. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	public SendSignalNodeItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ControlFlowsPackage.Literals.SEND_SIGNAL_NODE__IN_CONTROL_FLOW_PORT);
			childrenFeatures.add(ControlFlowsPackage.Literals.SEND_SIGNAL_NODE__OUT_CONTROL_FLOW_PORT);
		}
	...
	/**
	 * This returns SendSignalNode.gif. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	@Override
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/SendSignalNode"));
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(SendSignalNode.class)) {
		case ControlFlowsPackage.SEND_SIGNAL_NODE__IN_CONTROL_FLOW_PORT:
		case ControlFlowsPackage.SEND_SIGNAL_NODE__OUT_CONTROL_FLOW_PORT:
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		final boolean qualify = childFeature == ControlFlowsPackage.Literals.SEND_SIGNAL_NODE__IN_CONTROL_FLOW_PORT
				|| childFeature == ControlFlowsPackage.Literals.SEND_SIGNAL_NODE__OUT_CONTROL_FLOW_PORT;
