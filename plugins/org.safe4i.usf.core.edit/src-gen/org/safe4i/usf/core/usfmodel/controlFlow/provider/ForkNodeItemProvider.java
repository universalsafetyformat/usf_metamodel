...
/**
 * This is the item provider adapter for a {@link org.safe4i.usf.core.usfmodel.controlFlow.ForkNode} object. <!-- begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class ForkNodeItemProvider extends AbstractBlockTypeItemProvider {
	/**
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ControlFlowsPackage.Literals.FORK_NODE__IN_CONTROL_FLOW_PORT);
			childrenFeatures.add(ControlFlowsPackage.Literals.FORK_NODE__OUT_CONTROL_FLOW_PORTS);
		}
	...
	/**
	 * This returns ForkNode.gif. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	@Override
	...
	public void notifyChanged(Notification notification) {
		...
		case ControlFlowsPackage.FORK_NODE__IN_CONTROL_FLOW_PORT:
		case ControlFlowsPackage.FORK_NODE__OUT_CONTROL_FLOW_PORTS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors
				.add(createChildParameter(ControlFlowsPackage.Literals.FORK_NODE__IN_CONTROL_FLOW_PORT, ControlFlowsFactory.eINSTANCE.createControlFlowPort()));
		...
		newChildDescriptors.add(
				createChildParameter(ControlFlowsPackage.Literals.FORK_NODE__OUT_CONTROL_FLOW_PORTS, ControlFlowsFactory.eINSTANCE.createControlFlowPort()));
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		final boolean qualify = childFeature == ControlFlowsPackage.Literals.FORK_NODE__IN_CONTROL_FLOW_PORT
				|| childFeature == ControlFlowsPackage.Literals.FORK_NODE__OUT_CONTROL_FLOW_PORTS;
