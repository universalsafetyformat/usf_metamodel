...
import org.safe4i.usf.core.usfmodel.safetyPattern.SafetyPatternFactory;
import org.safe4i.usf.core.usfmodel.safetyPattern.SafetyPatternPackage;
import org.safe4i.usf.core.usfmodel.safetyPattern.util.SafetyPatternAdapterFactory;
 ...
 * @generated
 */
public class SafetyPatternItemProviderAdapterFactory extends SafetyPatternAdapterFactory
	 ...
	 * @generated
	 */
	public SafetyPatternItemProviderAdapterFactory() {
	...
	/**
	 * This keeps track of the one adapter used for all {@link org.safe4i.usf.core.usfmodel.safetyPattern.SafetyPatternApplication} instances. <!--
	 * begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	protected SafetyPatternApplicationItemProvider safetyPatternApplicationItemProvider;

	/**
	 * This creates an adapter for a {@link org.safe4i.usf.core.usfmodel.safetyPattern.SafetyPatternApplication}. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	@Override
	public Adapter createSafetyPatternApplicationAdapter() {
		if (safetyPatternApplicationItemProvider == null) {
			safetyPatternApplicationItemProvider = new SafetyPatternApplicationItemProvider(this);
		}

		return safetyPatternApplicationItemProvider;
	}

	/**
	 * This keeps track of the one adapter used for all {@link org.safe4i.usf.core.usfmodel.safetyPattern.SafetyPattern} instances. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @generated
	 */
	protected SafetyPatternItemProvider safetyPatternItemProvider;

	/**
	 * This creates an adapter for a {@link org.safe4i.usf.core.usfmodel.safetyPattern.SafetyPattern}. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	@Override
	public Adapter createSafetyPatternAdapter() {
		if (safetyPatternItemProvider == null) {
			safetyPatternItemProvider = new SafetyPatternItemProvider(this);
		}

		return safetyPatternItemProvider;
	}
	...
	public void dispose() {
		if (safetyPatternApplicationItemProvider != null) {
			safetyPatternApplicationItemProvider.dispose();
		}
		if (safetyPatternItemProvider != null) {
			safetyPatternItemProvider.dispose();
		}
	}
	...
	public static class CommonsChildCreationExtender implements IChildCreationExtender {
		...
		protected static class CreationSwitch extends CommonsSwitch<Object> {
			...
			public Object caseModel(Model object) {
				newChildDescriptors
						.add(createChildParameter(CommonsPackage.Literals.MODEL__CONTENT, SafetyPatternFactory.eINSTANCE.createSafetyPatternApplication()));

				newChildDescriptors.add(createChildParameter(CommonsPackage.Literals.MODEL__CONTENT, SafetyPatternFactory.eINSTANCE.createSafetyPattern()));
