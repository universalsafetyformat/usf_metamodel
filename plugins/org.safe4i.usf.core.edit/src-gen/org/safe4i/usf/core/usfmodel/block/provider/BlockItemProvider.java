...
/**
 * This is the item provider adapter for a {@link org.safe4i.usf.core.usfmodel.block.Block} object. <!-- begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class BlockItemProvider extends NamedElementItemProvider {
	...
	protected void addTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_Block_type_feature"), getString("_UI_PropertyDescriptor_description", "_UI_Block_type_feature", "_UI_Block_type"),
				BlocksPackage.Literals.BLOCK__TYPE, true, false, true, null, null, null));
	}
	...
	public String getText(Object object) {
		...
		if (blockType == null) {
			return "[Block] " + blockName + ":<No BlockType>";
		}

		final String blockTypeName = blockType.getName() == null || blockType.getName().isEmpty() ? LabelProviderHelper.NO_NAME_LITERAL : blockType.getName();

		return "[Block] " + blockName + ":" + blockTypeName;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		case BlocksPackage.BLOCK__DOCUMENTATION:
		case BlocksPackage.BLOCK__UNIQUE_IDENTIFIER:
