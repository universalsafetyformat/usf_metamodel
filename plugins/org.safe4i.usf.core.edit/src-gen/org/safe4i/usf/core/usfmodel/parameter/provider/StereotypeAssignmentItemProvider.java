...
/**
 * This is the item provider adapter for a {@link org.safe4i.usf.core.usfmodel.parameter.StereotypeAssignment} object. <!-- begin-user-doc --> <!-- end-user-doc
 * -->
 * 
 * @generated
 */
public class StereotypeAssignmentItemProvider extends ItemProviderAdapter
	 ...
	 * @generated
	 */
	public StereotypeAssignmentItemProvider(AdapterFactory adapterFactory) {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addAssignedStereotypesPropertyDescriptor(object);
		}
	...
	/**
	 * This adds a property descriptor for the Assigned Stereotypes feature. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	protected void addAssignedStereotypesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_StereotypeAssignment_assignedStereotypes_feature"),
				getString("_UI_PropertyDescriptor_description", "_UI_StereotypeAssignment_assignedStereotypes_feature", "_UI_StereotypeAssignment_type"),
				ParametersPackage.Literals.STEREOTYPE_ASSIGNMENT__ASSIGNED_STEREOTYPES, true, false, true, null, null, null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ParametersPackage.Literals.STEREOTYPE_ASSIGNMENT__VALUES);
		}
	...
	public String getText(Object object) {
		final StereotypeAssignment element = (StereotypeAssignment) object;
		final String eClassName = LabelProviderHelper.INSTANCE.beautifyCamelCaseString(element.eClass().getName());
		if (element instanceof BlockStereotypeAssignment) {
			return "[" + eClassName + "]" + ((BlockStereotypeAssignment) element).getContext();
		} else if (element instanceof BlockTypeStereotypeAssignment) {
			return "[" + eClassName + "]" + ((BlockTypeStereotypeAssignment) element).getContext();
		} else if (element instanceof PortStereotypeAssignment) {
			return "[" + eClassName + "]" + ((PortStereotypeAssignment) element).getContext();
		} else if (element instanceof ConnectionStereotypeAssignment) {
			return "[" + eClassName + "]" + ((ConnectionStereotypeAssignment) element).getContext();
		} else {
			return "[" + eClassName + "]";
		}
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(StereotypeAssignment.class)) {
		case ParametersPackage.STEREOTYPE_ASSIGNMENT__UNIQUE_IDENTIFIER:
			fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
			return;
		case ParametersPackage.STEREOTYPE_ASSIGNMENT__VALUES:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(
				createChildParameter(ParametersPackage.Literals.STEREOTYPE_ASSIGNMENT__VALUES, ParametersFactory.eINSTANCE.createPrimitiveParameterValue()));
	}
