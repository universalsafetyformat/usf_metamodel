...
/**
 * This is the item provider adapter for a {@link org.safe4i.usf.core.usfmodel.block.PortInstance} object. <!-- begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class PortInstanceItemProvider extends ItemProviderAdapter
	...
	protected void addPortPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_PortInstance_port_feature"),
				getString("_UI_PropertyDescriptor_description", "_UI_PortInstance_port_feature", "_UI_PortInstance_type"),
				BlocksPackage.Literals.PORT_INSTANCE__PORT, true, false, true, null, null, null));
	}

	/**
	 * This adds a property descriptor for the Block feature. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	protected void addBlockPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_PortInstance_block_feature"),
				getString("_UI_PropertyDescriptor_description", "_UI_PortInstance_block_feature", "_UI_PortInstance_type"),
				BlocksPackage.Literals.PORT_INSTANCE__BLOCK, true, false, true, null, null, null));
	}
