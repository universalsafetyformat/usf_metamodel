...
/**
 * This is the item provider adapter for a {@link org.safe4i.usf.core.usfmodel.common.Model} object. <!-- begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class ModelItemProvider extends ItemProviderAdapter
	...
	public String getText(Object object) {
		final String label = ((Model) object).getUniqueIdentifier();
	...
	public void notifyChanged(Notification notification) {
		...
		case CommonsPackage.MODEL__UNIQUE_IDENTIFIER:
			fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
			return;
		case CommonsPackage.MODEL__CONTENT:
